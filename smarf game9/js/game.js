...
var col = calcCol(pos[0])								// タイル位置変換X
 ...
 function game() {
    ...
    //////////////////////////////
    // 初期化処理
    if (gFirstGamFlg == 1 && gMode == 2) {
        gMode = 0;
        gImgTile = new image("./images/Tile3.png");
        gImgPlayer = new image("./images/Main.png");
        gImageHardStage = new image("./images/HardStage.png");
        ...
        gImageHardTile1 = new image("./images/HardTile1.png");
        gImageHardTile2 = new image("./images/HardTile2.png");
        gPlayerX = 3;
        gPlayerY = 2;
        gPlayerDistX = 0;
        gPlayerDistY = 0;
...
[
    ...
    //////////////////////////////
    // 表示処理	
    gImageHardStage.draw(0, 0, 0, 0, 1366, 834)
    ...
    if (TERN % 2 == 1) {
        gImageHardTile1.draw(0, 0, 0, 0, 1366, 834)
    } else {
        gImageHardTile2.draw(0, 0, 0, 0, 1366, 834)
    }
    //格子表示
